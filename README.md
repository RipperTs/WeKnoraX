# 💡 WeKnoraX — 让文档真正被理解和运用

## 📌 项目介绍

**WeKnoraX（维娜拉）** 是一款开源的、基于大语言模型（LLM）的知识管理框架，专为企业级文档理解、语义检索与智能推理场景打造。
...
本项目基于原始项目 [WeKnora](https://github.com/Tencent/WeKnora) 基础上进行二次开发，特别感谢 WeKnora 团队的贡献。
...
```bash
git clone https://github.com/RipperTs/WeKnora.git
cd WeKnora
