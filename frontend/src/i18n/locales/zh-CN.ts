export default {
  ...
  thirdPartyIntegration: {
    ...
    tenant: {
      navLabel: '第三方连接',
      title: '第三方连接',
      description: '管理当前空间允许接入的应用，以及你已授权给第三方的知识库。',
      applications: '空间应用策略',
      applicationsDescription: '空间管理员可进一步收紧应用权限和知识库范围。',
      configure: '配置',
      restrictedSummary: '{scopes} · 限定 {count} 个知识库',
      unrestrictedSummary: '{scopes} · 可由用户从当前可访问知识库中选择',
      empty: '系统管理员尚未注册可用应用',
    ...
    connections: {
      ...
      connected: '已连接',
      unavailable: '已停用',
      summary: '{count} 个知识库 · {scopes}',
      unavailableSummary: '应用或空间策略已停用，连接凭证和启动入口均不可用。',
      open: '打开',
      revoke: '撤销',
    ...
    policy: {
      ...
      enabled: '允许在当前空间使用',
      enabledHint: '关闭后，当前空间下的已有连接将立即停止工作。',
      knowledgeBases: '空间允许的知识库',
      allKnowledgeBases: '不限定，由用户授权时选择',
      knowledgeBasesHint: '留空表示用户可从当前有权访问的全部知识库中自行选择。',
    },
    authorization: {
      loading: '正在校验连接请求…',
      errorTitle: '无法完成连接',
      ...
      permissions: '应用将获得',
      readTitle: '读取与检索已选知识库',
      readDescription: '仅能读取你在下方明确选择、且当前仍有权访问的知识库。',
      chatTitle: '基于知识库发起问答',
      chatDescription: '允许应用调用知识问答接口，但不能写入、修改或删除内容。',
      selectKnowledgeBases: '选择知识库',
      selectKnowledgeBasesHint: '以后可在设置中撤销整个连接。',
      noKnowledgeBases: '当前空间没有可授权的知识库',
      footerHint: 'WeKnora 会在每次请求时重新计算有效权限。',
      deny: '拒绝',
      allow: '确认连接',
      submitFailed: '提交授权结果失败',
      loadFailed: '加载授权请求失败',
      knowledgeBaseType: { document: '文档知识库', faq: 'FAQ 知识库', wiki: 'Wiki 知识库' },
    },
    launch: {
      loading: '正在打开你的知识库…',
      errorTitle: '无法打开连接',
      title: '选择要打开的知识库',
      description: '以下内容来自你此前授权给该应用的有效范围。',
      openHint: '点击进入知识库',
      empty: '此连接当前没有可访问的知识库，请重新授权或联系空间管理员。',
      loadFailed: '加载连接失败',
    },
  },
  common: {
