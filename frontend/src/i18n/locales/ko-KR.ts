export default {
  ...
  thirdPartyIntegration: {
    ...
    tenant: {
      ...
      description: '현재 워크스페이스에서 허용된 앱과 승인한 지식 베이스를 관리합니다.',
      applications: '워크스페이스 앱 정책', applicationsDescription: '관리자는 권한과 지식 베이스 범위를 더 제한할 수 있습니다.',
      configure: '설정', restrictedSummary: '{scopes} · 지식 베이스 {count}개로 제한',
      unrestrictedSummary: '{scopes} · 사용자가 접근 가능한 지식 베이스에서 선택',
    ...
    policy: {
      ...
      enabled: '이 워크스페이스에서 허용', enabledHint: '비활성화하면 이 워크스페이스의 모든 연결이 즉시 중지됩니다.',
      knowledgeBases: '워크스페이스 허용 지식 베이스', allKnowledgeBases: '제한 없음, 승인 시 사용자가 선택',
      knowledgeBasesHint: '비워 두면 사용자가 현재 접근 가능한 모든 지식 베이스에서 선택할 수 있습니다.',
    },
    authorization: {
      ...
      permissions: '앱 권한', readTitle: '선택한 지식 베이스 읽기 및 검색',
      readDescription: '아래에서 선택하고 현재도 접근 가능한 지식 베이스만 읽을 수 있습니다.',
      chatTitle: '지식 베이스 기반 질의응답', chatDescription: '지식 Q&A는 호출할 수 있지만 콘텐츠 작성, 수정, 삭제는 할 수 없습니다.',
      selectKnowledgeBases: '지식 베이스 선택', selectKnowledgeBasesHint: '나중에 설정에서 연결을 취소할 수 있습니다.',
      noKnowledgeBases: '승인 가능한 지식 베이스가 없습니다', footerHint: 'WeKnora는 요청마다 유효 권한을 다시 계산합니다.',
      deny: '거부', allow: '연결', submitFailed: '승인 결과 제출 실패', loadFailed: '승인 요청을 불러오지 못했습니다',
      knowledgeBaseType: { document: '문서 지식 베이스', faq: 'FAQ 지식 베이스', wiki: 'Wiki 지식 베이스' },
    },
    launch: {
      loading: '지식 베이스를 여는 중…', errorTitle: '연결을 열 수 없습니다', title: '지식 베이스 선택',
      description: '이전에 앱에 승인한 현재 유효 범위입니다.', openHint: '지식 베이스 열기',
      empty: '현재 접근 가능한 지식 베이스가 없습니다. 다시 승인하거나 관리자에게 문의하세요.',
