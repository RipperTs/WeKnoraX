export default {
  ...
  thirdPartyIntegration: {
    ...
    authorization: {
      ...
      noWorkspaces: '현재 이 앱을 허용하는 워크스페이스가 없습니다', footerHint: 'WeKnora는 요청마다 유효 권한을 다시 계산합니다.',
    ...
    launch: {
      ...
      description: '현재 이 연결에 승인된 모든 워크스페이스의 리소스입니다.', workspaces: '승인된 워크스페이스', openHint: '지식 베이스 열기',
