export default {
  ...
  thirdPartyIntegration: {
    ...
    tenant: {
      ...
      description: 'Управление разрешёнными приложениями и базами знаний, доступ к которым вы предоставили.',
      applications: 'Политики приложений пространства',
      applicationsDescription: 'Администраторы пространства могут дополнительно ограничить права и базы знаний.',
      configure: 'Настроить', restrictedSummary: '{scopes} · Баз знаний: {count}',
      unrestrictedSummary: '{scopes} · Пользователь выбирает из доступных баз знаний',
    ...
    connections: {
      ...
      summary: 'Баз знаний: {count} · {scopes}',
      unavailableSummary: 'Приложение или политика пространства отключены; учётные данные и запуск недоступны.',
    ...
    policy: {
      ...
      enabled: 'Разрешить в этом пространстве', enabledHint: 'Отключение сразу остановит все подключения пространства.',
      knowledgeBases: 'Разрешённые базы знаний', allKnowledgeBases: 'Без ограничения; пользователь выбирает при подтверждении',
      knowledgeBasesHint: 'Оставьте пустым, чтобы пользователь мог выбрать любую доступную ему базу знаний.',
    },
    authorization: {
      ...
      permissions: 'Приложение сможет', readTitle: 'Читать и искать в выбранных базах знаний',
      readDescription: 'Доступны только выбранные ниже базы знаний, к которым у вас по-прежнему есть доступ.',
      ...
      selectKnowledgeBases: 'Выберите базы знаний', selectKnowledgeBasesHint: 'Позже подключение можно отозвать в настройках.',
      noKnowledgeBases: 'Нет баз знаний, доступных для авторизации',
      footerHint: 'WeKnora пересчитывает действующие разрешения при каждом запросе.',
      ...
      knowledgeBaseType: { document: 'Документы', faq: 'FAQ', wiki: 'Wiki' },
    },
    launch: {
      loading: 'Открываем ваши базы знаний…', errorTitle: 'Не удалось открыть подключение',
      title: 'Выберите базу знаний', description: 'Ресурсы, доступные через это подключение сейчас.',
      openHint: 'Открыть базу знаний',
      empty: 'В подключении нет доступных баз знаний. Авторизуйте его заново или обратитесь к администратору.',
