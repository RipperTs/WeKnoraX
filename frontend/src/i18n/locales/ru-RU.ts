    ...
    globalSettings: {
      ...
      audit: {
        ...
        action: {
          ...
          'system.queue_pending_cancelled': 'Начата отмена ожидающих задач'
        },
        columns: {
          time: 'Время',
          actor: 'Кто',
      ...
      runtime: {
        ...
        tasks: {
          ...
          cancelPending: 'Отменить ожидающие задачи',
          cancelPendingConfirm: 'Отменить задачи, ожидающие в этой очереди в начале операции (сейчас около {count}), и завершить их бизнес-состояние. Для документа отменяется весь процесс и связанные задачи. Необходимая очистка сохраняется. Новые задачи исключаются; ошибки и изменения состояния пропускаются. Операция продолжится после закрытия страницы. Продолжить?',
          cancelPendingError: 'Не удалось начать отмену',
          cancellationProgressError: 'Не удалось получить ход отмены. Обновите страницу.',
          cancellationProgress: 'Обработано {processed}/{total} · Отменено {cancelled} · Пропущено {skipped} · Ошибок {failed}',
          cancellationRelated: 'Удалено связанных задач: {related_deleted}; сигнал отмены отправлен активным задачам: {active_signaled}',
          cancellationStatus: {
            running: 'Отмена ожидающих задач',
            completed: 'Отмена завершена',
            failed: 'Отмена завершена не полностью',
          },
          ...
          guides: {
            ...
            pending: 'Задачи ещё не взяты исполнителем. Отмена одной задачи обновляет бизнес-состояние; «Очистить очередь» удаляет только задачи Redis/Asynq.',
