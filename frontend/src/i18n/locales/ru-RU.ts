    ...
    globalSettings: {
      ...
      runtime: {
        ...
        tasks: {
          ...
          purgePending: 'Очистить очередь',
          purgePendingConfirm: 'Удалить все ожидающие задачи ({count}) непосредственно из этой очереди. Будут удалены только ещё не запущенные задачи Redis/Asynq; состояние документов и другие бизнес-данные не изменятся. Очистить?',
          purgePendingSuccess: 'Удалено ожидающих задач: {count}',
          purgePendingError: 'Не удалось очистить ожидающие задачи',
