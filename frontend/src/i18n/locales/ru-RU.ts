    ...
    globalSettings: {
      ...
      runtime: {
        ...
        purge: {
          ...
          liveWarning: 'Операция может затронуть несколько рабочих пространств и отменяет связанные операции и задачи того же документа в других очередях. Для Wiki также обрабатываются связанные задачи той же базы знаний. Записанные и удалённые данные не восстанавливаются. Выполняемые обработчики должны завершиться; задачи, которые не удалось остановить или очистить, будут указаны. Новые задачи могут продолжать поступать.',
