export default {
  ...
  knowledgeEditor: {
    ...
    apiAccess: {
      title: 'API Access',
      description: 'Create a dedicated key that only lets a third-party system write documents to this knowledge base.',
      endpointLabel: 'Document synchronization endpoint',
      scopeNotice: 'The key is bound to this knowledge base and only grants the ingest capability.',
