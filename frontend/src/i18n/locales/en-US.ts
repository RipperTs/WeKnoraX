export default {
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        ...
        desc: 'Everything starts here: upload documents, web pages or FAQs and the system parses and indexes them automatically. Click here to open knowledge bases.'
      },
      chat: {
  ...
  agent: {
    ...
    editor: {
      ...
      titleModelPlaceholder: 'Leave empty to reuse the main chat model',
  ...
  settings: {
    ...
    sandbox: {
      ...
      backendDescriptions: {
        ...
        docker: 'Keep a long-lived container per session on this server host; scripts and files stay in that container',
      ...
      templateUntaggedHint: 'The builds finished but none carries the default tag, so sandbox creation cannot resolve this template. Delete it in E2B and refresh; the system will rebuild it.',
    ...
    weknoraCloud: {
      title: 'Cloud Service',
      description: 'Configure the cloud service APPID and APPSECRET credentials for model services and document parsing.',
      viewDocs: 'View Docs',
      unconfigured: 'Credentials not configured. Please fill in APPID and APPSECRET.',
      configured: 'Credentials configured and working.',
      expired: 'Cloud service credentials expired',
      ...
      appIdLabel: 'APPID',
      appIdDesc: 'Cloud service application ID',
      appIdPlaceholder: 'Enter APPID',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: 'Cloud service application secret',
      ...
      credentialConfigured: 'Cloud service credentials configured.',
      credentialExpired: 'Credentials expired. Please reconfigure.',
      credentialUnconfigured: 'Cloud service credentials not configured. Please set up APPID and APPSECRET first.',
      checkingStatus: 'Checking credential status...',
      goToSettings: 'Go to Settings',
      modelHintConfigured: 'Cloud service credentials configured. See supported models in',
      modelHintDocsLink: 'API docs',
      modelsSection: {
        title: 'Cloud Models',
        descReady: 'Register the four standard cloud models for chat, retrieval, reranking, and vision.',
      ...
      addModelsDisplayName: {
        chat: 'Cloud Chat Model',
        embedding: 'Cloud Embedding Model',
        rerank: 'Cloud Rerank Model',
        vllm: 'Cloud Vision Model'
      }
    },
    ...
    storage: {
      ...
      pathPrefixPlaceholder: 'e.g. knowledge/images',
      prefixPlaceholder: 'e.g. knowledge',
  ...
  auth: {
    ...
    redirectingToSSO: 'Redirecting to authentication center...',
    orContinueWith: 'Or continue with',
    oidcLoginFailed: 'OIDC login failed',
    quickLogin: 'Quick Login',
    quickLoginDescription: 'Choose your organization to sign in with your corporate account',
    ...
    jianlongSSOProvider: 'Jianlong Group',
    jianlongSSOLogin: 'Jianlong Group SSO',
    jianlongSSODescription: 'Sign in with Jianlong Group unified identity authentication',
    username: 'Username',
    ...
    firstTime: 'New to Knowledge Base?',
    registerSuccess: 'Registration successful. Please sign in',
    registerFailed: 'Registration failed',
    subtitle: 'RAG Q&A, ReAct Agent and Wiki — an LLM-powered enterprise knowledge framework',
    registerSubtitle: 'Create your account and start using Knowledge Base',
    loginAccountPlaceholder: 'Enter username or email address',
    emailPlaceholder: 'Enter email address',
    passwordPlaceholder: 'Enter password (8-32 characters, including letters and numbers)',
    confirmPasswordPlaceholder: 'Enter password again',
    usernamePlaceholder: 'Enter username',
    loginAccountRequired: 'Enter username or email address',
  ...
  thirdPartyIntegration: {
    system: {
      navLabel: 'Third-party apps', title: 'Third-party apps',
      description: 'Register trusted systems and manage their callbacks and requestable permissions.',
      create: 'Register app', edit: 'Edit app',
      formDescription: 'The Client Secret is shown only after creation or rotation.',
      noDescription: 'No description', redirectCount: '{count} callback URLs',
      testConnection: 'Test connection', testSuccess: 'All {count} callback URLs are reachable. HTTP status: {statuses}',
      testFailed: 'Connection test failed. {reachable}/{total} reachable. {url}: {error}',
      testRequestFailed: 'Connection test request failed', testUnknownError: 'Unknown error',
      deleteTitle: 'Delete third-party app',
      deleteConfirm: 'Delete “{name}”? Its workspace policies, user authorizations, connections, and access credentials will also be permanently deleted.',
      deleted: 'Third-party app deleted', deleteFailed: 'Failed to delete third-party app',
      rotateSecret: 'Rotate secret',
      rotateTitle: 'Rotate Client Secret',
      rotateConfirm: 'Rotate the Client Secret for “{name}”? The old secret becomes invalid immediately.',
      rotateFailed: 'Failed to rotate secret', emptyTitle: 'No third-party apps registered',
      emptyDescription: 'Register an app so it can request user authorization.',
      required: 'Enter an app name and at least one callback URL', loadFailed: 'Failed to load apps',
      saved: 'App saved', saveFailed: 'Failed to save app',
    },
    fields: {
    ...
    scopes: {
      read: 'Read and search knowledge bases',
      chat: 'Ask questions using knowledge bases',
    },
    secret: {
      title: 'Save app credentials', copy: 'Copy Client Secret',
      warning: 'This Client Secret is shown once. Store it now in the third-party server’s secure configuration.',
    },
    tenant: {
      navLabel: 'Third-party connections', title: 'Third-party connections',
      description: 'Manage apps allowed in this workspace and your multi-workspace connections.',
      applications: 'Workspace app policies',
      applicationsDescription: 'Workspace admins control whether an app can access this workspace and which permissions it may use.',
      configure: 'Configure',
      unrestrictedSummary: '{scopes} · Knowledge bases follow the workspaces authorized by each user',
      empty: 'No apps have been registered by a system administrator', loadFailed: 'Failed to load connections',
      saved: 'Workspace policy saved', saveFailed: 'Failed to save workspace policy',
    },
    connections: {
      ...
      summary: '{spaces} workspaces · {count} knowledge bases · {scopes}',
      unavailableSummary: 'The app is disabled or none of its authorized workspaces are currently available.',
    ...
    policy: {
      title: 'Configure {name}', description: 'Workspace policy can only narrow the system app configuration.',
      enabled: 'Allow in this workspace',
      enabledHint: 'Disabling immediately removes this workspace from existing connections.',
    },
    authorization: {
      loading: 'Validating connection request…', errorTitle: 'Unable to connect',
      eyebrow: 'Third-party authorization',
      title: 'Allow “{name}” to connect to your knowledge bases?',
      credentialNotice: 'The app receives a separate credential. Your login Token and OIDC credentials are never shared.',
      permissions: 'The app will be able to', readTitle: 'Read and search knowledge bases in selected workspaces',
      readDescription: 'The app can read knowledge bases you can currently access in the selected workspaces. Permission changes apply immediately.',
      chatTitle: 'Answer questions using knowledge bases',
      chatDescription: 'The app may call knowledge Q&A, but cannot write, modify, or delete content.',
      selectWorkspaces: 'Select workspaces', selectWorkspacesHint: 'You can select multiple workspaces and reauthorize or revoke the connection later.',
      noWorkspaces: 'There are no workspaces that currently allow this app',
      footerHint: 'Effective permissions are recalculated on every request.', deny: 'Deny', allow: 'Connect',
      submitFailed: 'Failed to submit authorization', loadFailed: 'Failed to load authorization request',
    },
    launch: {
      loading: 'Opening your knowledge bases…', errorTitle: 'Unable to open connection',
      successLabel: 'Authorization complete',
      title: 'Connected successfully', description: '“{name}” now has the access you approved. Open a knowledge base below.',
      workspaceCount: 'Authorized workspaces', knowledgeBaseCount: 'Accessible knowledge bases',
      workspaces: 'Authorized workspaces',
      knowledgeBases: 'Choose a knowledge base',
      openHint: 'Open knowledge base',
      empty: 'The authorized workspaces currently have no accessible knowledge bases. Reauthorize or contact a workspace admin.',
  ...
  createChat: {
    title: 'Hi, I am your knowledge assistant',
  ...
  knowledgeEditor: {
    ...
    apiAccess: {
      title: 'API Access',
      description: 'Synchronize documents from an external system with this knowledge base: create, update, query, and delete.',
      createTitle: 'Create access key',
      createDescription: 'Name the key after the source system so it is easy to identify and revoke.',
      namePlaceholder: 'For example: Policy system',
      create: 'Create key',
      ...
      sourceIdHint: 'A stable source system identifier, up to 128 characters, such as policy-system.',
      externalIdHint: 'A unique document identifier within the source system, up to 512 characters. Use the same identifier for all three operations.',
      ...
      revokeConfirmBody: 'After revoking “{name}”, third-party synchronization using this key will stop immediately.',
      revokeSuccess: 'Key revoked',
      revokeFailed: 'Failed to revoke key',
      nameRequired: 'Enter a key name',
      loadFailed: 'Failed to load access keys',
      createFailed: 'Failed to create access key',
      createSuccess: 'Access key created',
      copySuccess: 'Key copied',
      docsTab: 'API reference',
      keysTab: 'Access keys',
      authStep: 'Add the authentication header',
      callStep: 'Choose an operation and call it',
      chooseOperation: 'Choose an API operation',
      upsertTitle: 'Create / update',
      upsertDescription: 'Upload a document file. Matching source and document identifiers update the existing document; a new identifier creates a document.',
      upsertResponseHint: '202 means accepted; parsing continues in the background. Use GET to check progress. The action is created or updated; unchanged content that is processing or completed returns 200 and skipped.',
      getTitle: 'Check status',
      getDescription: 'Look up parsing progress, the current document ID, and the processing result using the source and document identifiers.',
      getResponseHint: 'parse_status is completed when processing finishes. For failed, inspect error_message. Missing documents return 404. Query responses do not contain an action field.',
      deleteTitle: 'Delete document',
      deleteDescription: 'When a source document is deleted or withdrawn, use the same source and document identifiers to delete it from this knowledge base.',
      deleteResponseHint: 'Success returns 200 and deleted. If the document is already absent, it returns 200 and skipped. This removes the document and its related indexes; parse_status describes its state before deletion.',
      ...
      required: 'Yes',
      optional: 'No',
      fileHint: 'The document file. Supported formats and size limits depend on server configuration. Updates also require the complete file.',
      metadataHint: 'A JSON object with string values, such as department or category. Metadata changes also trigger an update.',
      requestExampleTitle: 'Request example',
      responseExampleTitle: 'Response example',
      exampleHint: 'The URL uses the current site and knowledge base. Replace API_KEY and both identifiers. For uploads, also replace the local file path.',
      statusesTitle: 'Processing statuses',
      statusPending: 'Waiting for processing',
      statusProcessing: 'Parsing, chunking, or embedding',
      statusFinalizing: 'Generating summaries, questions, or the knowledge graph',
      statusCompleted: 'Processing completed',
      statusFailed: 'Processing failed. Check error_message; submit the document again with PUT.',
      statusCancelled: 'Processing cancelled. Submit the document again with PUT.',
      errorsTitle: 'Common errors',
      error400: 'Invalid parameters, file format, size, or metadata',
      error401: 'Missing or invalid API key',
      error403: 'The key lacks ingest permission for this knowledge base or its scope denies access',
      error404: 'Knowledge base not found, or GET could not find the document',
      error409: 'The document conflicts with an existing record',
      error429: 'Workspace storage quota exhausted',
      error500: 'Server processing failed. Check the service logs.',
      syncRulesTitle: 'Repeated calls and synchronization',
      identityRule: 'Within a knowledge base, source_id + external_id uniquely identifies a document for creation, updates, queries, and deletion.',
      skipRule: 'If filename, content, and metadata are unchanged and processing is active or completed, repeated PUT returns skipped. Resubmitting after failure or cancellation starts processing again.',
      updateRule: 'Updates create a new document and clean up the old one, so knowledge_id changes. Keep using source_id and external_id for synchronization.',
      orderRule: 'Requests for the same document execute serially, but the server cannot determine business version order. Send requests in the order the source document changes.',
      columns: {
        name: 'Name',
        key: 'Key',
        createdAt: 'Created',
    ...
    globalSettings: {
      ...
      runtime: {
        ...
        purge: {
          ...
          liveWarning: 'This may affect multiple workspaces and cancel related business operations and tasks for the same document. Wiki cleanup also includes related tasks for the same knowledge base. Existing writes and deletions are not rolled back. Knowledge base and index deletion tasks are retained to finish resource cleanup. Other running handlers must exit; tasks that cannot stop or be cleared will be reported. New tasks can still enter the queue.',
          historyWarning: 'Ordinary history entries only have their queue records removed. If quarantined tasks from an incomplete cleanup are present, their required finalization is retried first. Original tasks are not executed again, and document content is not rolled back.',
      ...
      keyLabels: {
        ...
        tenant: {
          ...
          auto_accept_invitation: 'Automatically accept workspace invitations'
        },
        asynq: {
      ...
      keyDescriptions: {
        ...
        tenant: {
          ...
          auto_accept_invitation: 'When enabled, inviting a registered user adds them to the workspace immediately without manual acceptance or a pending invitation. When disabled, the invited user must confirm the invitation. Takes effect immediately.'
        },
        asynq: {
  ...
  model: {
    ...
    editor: {
      ...
      sortOrderPlaceholder: 'Default: 100',
      sortOrderDesc: 'Controls model order in user-facing selectors. Lower values appear first; ties use creation time descending.',
      ...
      providers: {
        ...
        weknoracloud: {
          label: 'Cloud Models',
          description: 'Cloud model service for chat, embedding, rerank, and VLM models'
        },
        siliconflow: {
          label: 'SiliconFlow',
  ...
  kbSettings: {
    ...
    parser: {
      ...
      engines: {
        ...
        weknoracloud: {
          name: 'Cloud Parsing',
          desc: 'Document parsing via the cloud service'
        },
        markitdown: {
          name: 'MarkItDown',
  ...
  agentEditor: {
    ...
    desc: {
      ...
      titleModel: 'Model used to generate session titles. Leave empty to reuse the main chat model.',
  ...
  integrations: {
    ...
    api: {
      ...
      capabilityManageModelsHint: 'Manage model definitions, credentials, connectivity checks, and Cloud service credentials.',
      ...
      hmacSecretDesc: 'Same secret stored in the knowledge base server; used only on your backend to sign JWTs—never send it as a request header.',
    ...
    chrome: {
      ...
      subtitle: 'For your self-hosted knowledge base: ask questions in a sidebar, clip web pages, and save Markdown notes into your knowledge bases while you browse.',
      ...
      steps: {
        ...
        port: {
          ...
          desc: 'In the knowledge base desktop app, set a fixed API port (e.g. 37841) in API Info so the URL stays stable across restarts.'
        },
        install: {
    ...
    claw: {
      ...
      subtitle: 'Import documents and run hybrid retrieval (vector + keyword) via the knowledge base REST API—for uploads, URL imports, Markdown entries, and cross-KB search.',
      ...
      installCtaHint: 'Install Knowledge Base Skill · opens in a new tab',
  ...
  userProfile: {
    ...
    changePassword: {
      ...
      description: 'Set a new sign-in password. All signed-in sessions will be revoked and you will need to sign in again.',
