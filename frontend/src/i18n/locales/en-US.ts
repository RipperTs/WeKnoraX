export default {
  ...
  thirdPartyIntegration: {
    ...
    tenant: {
      ...
      description: 'Manage apps allowed in this workspace and knowledge bases you authorized.',
      applications: 'Workspace app policies',
      applicationsDescription: 'Workspace admins can further narrow permissions and knowledge-base access.',
      configure: 'Configure', restrictedSummary: '{scopes} · Limited to {count} knowledge bases',
      unrestrictedSummary: '{scopes} · Users select from currently accessible knowledge bases',
    ...
    policy: {
      ...
      enabledHint: 'Disabling immediately stops all connections in this workspace.',
      knowledgeBases: 'Workspace-allowed knowledge bases', allKnowledgeBases: 'No limit; user chooses at consent',
      knowledgeBasesHint: 'Leave empty to let users choose from every knowledge base they can currently access.',
    },
    authorization: {
      ...
      permissions: 'The app will be able to', readTitle: 'Read and search selected knowledge bases',
      readDescription: 'Only knowledge bases selected below and still accessible to you can be read.',
      ...
      selectKnowledgeBases: 'Select knowledge bases', selectKnowledgeBasesHint: 'You can revoke the connection later in Settings.',
      noKnowledgeBases: 'There are no knowledge bases available to authorize',
      footerHint: 'WeKnora recalculates effective permissions on every request.', deny: 'Deny', allow: 'Connect',
      submitFailed: 'Failed to submit authorization', loadFailed: 'Failed to load authorization request',
      knowledgeBaseType: { document: 'Document knowledge base', faq: 'FAQ knowledge base', wiki: 'Wiki knowledge base' },
    },
    launch: {
      loading: 'Opening your knowledge bases…', errorTitle: 'Unable to open connection',
      title: 'Choose a knowledge base', description: 'These are the resources currently available through this connection.',
      openHint: 'Open knowledge base',
      empty: 'This connection has no accessible knowledge bases. Reauthorize it or contact a workspace admin.',
